...
[machinery/dmViewFromOptions.yaml](https://github.com/UBCHREST/ablate/tree/main/tests/integrationTests/inputs/machinery/dmViewFromOptions.yaml)
```yaml
---
environment:
