---
layout: default
title: Two gas advecting discontinuity
parent: Examples Input Files
grand_parent: Running Simulations
nav_exclude: true
---

[volumeOfFluids/twoGasAdvectingDiscontinuity.yaml](https://github.com/UBCHREST/ablate/tree/main/tests/integrationTests/inputs/volumeOfFluids/twoGasAdvectingDiscontinuity.yaml)
```yaml
---
environment:
