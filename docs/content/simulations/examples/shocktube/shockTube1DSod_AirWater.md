---
layout: default
title: Shock tube1 d sod air water
parent: Examples Input Files
grand_parent: Running Simulations
nav_exclude: true
---

[shocktube/shockTube1DSod_AirWater.yaml](https://github.com/UBCHREST/ablate/tree/main/tests/integrationTests/inputs/shocktube/shockTube1DSod_AirWater.yaml)
```yaml
---
environment:
