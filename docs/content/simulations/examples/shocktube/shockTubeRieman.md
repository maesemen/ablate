---
layout: default
title: Shock tube rieman
parent: Examples Input Files
grand_parent: Running Simulations
nav_exclude: true
---

[shocktube/shockTubeRieman.yaml](https://github.com/UBCHREST/ablate/tree/main/tests/integrationTests/inputs/shocktube/shockTubeRieman.yaml)
```yaml
---
environment:
  title: SOD_Problem
