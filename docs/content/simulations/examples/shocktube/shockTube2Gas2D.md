---
layout: default
title: Shock tube2 gas2 d
parent: Examples Input Files
grand_parent: Running Simulations
nav_exclude: true
---

[shocktube/shockTube2Gas2D.yaml](https://github.com/UBCHREST/ablate/tree/main/tests/integrationTests/inputs/shocktube/shockTube2Gas2D.yaml)
```yaml
---
environment:
