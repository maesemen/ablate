---
layout: default
title: Tracer particles3 d
parent: Examples Input Files
grand_parent: Running Simulations
nav_exclude: true
---

[particles/tracerParticles3D.yaml](https://github.com/UBCHREST/ablate/tree/main/tests/integrationTests/inputs/particles/tracerParticles3D.yaml)
```yaml
---
environment:
