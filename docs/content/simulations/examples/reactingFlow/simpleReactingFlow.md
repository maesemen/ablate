---
layout: default
title: Simple reacting flow
parent: Examples Input Files
grand_parent: Running Simulations
nav_exclude: true
---

[reactingFlow/simpleReactingFlow.yaml](https://github.com/UBCHREST/ablate/tree/main/tests/integrationTests/inputs/reactingFlow/simpleReactingFlow.yaml)
```yaml
---
environment:
