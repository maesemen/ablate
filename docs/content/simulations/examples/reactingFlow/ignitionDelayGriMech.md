...
[reactingFlow/ignitionDelayGriMech.yaml](https://github.com/UBCHREST/ablate/tree/main/tests/integrationTests/inputs/reactingFlow/ignitionDelayGriMech.yaml)
```yaml
---
