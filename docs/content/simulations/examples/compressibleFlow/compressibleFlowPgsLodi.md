---
layout: default
title: Compressible flow pgs lodi
...
[compressibleFlow/compressibleFlowPgsLodi.yaml](https://github.com/UBCHREST/ablate/tree/main/tests/integrationTests/inputs/compressibleFlow/compressibleFlowPgsLodi.yaml)
```yaml
---
