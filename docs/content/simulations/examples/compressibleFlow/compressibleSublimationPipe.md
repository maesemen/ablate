---
layout: default
title: Compressible sublimation pipe
...
[compressibleFlow/compressibleSublimationPipe.yaml](https://github.com/UBCHREST/ablate/tree/main/tests/integrationTests/inputs/compressibleFlow/compressibleSublimationPipe.yaml)
```yaml
---
