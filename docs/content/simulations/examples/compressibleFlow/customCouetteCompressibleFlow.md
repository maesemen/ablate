---
layout: default
title: Custom couette compressible flow
...
[compressibleFlow/customCouetteCompressibleFlow.yaml](https://github.com/UBCHREST/ablate/tree/main/tests/integrationTests/inputs/compressibleFlow/customCouetteCompressibleFlow.yaml)
```yaml
---
...
solver: !ablate::finiteVolume::FiniteVolumeSolver
  ...
  processes:
    # the EulerTransport processes handles bulk advection and diffusion
